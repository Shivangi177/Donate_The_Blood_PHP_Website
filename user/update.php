            ...
            <div class="panel panel-default" style="padding:20px;">
                ...
                <form action="" method="post" class="form-group">
                    ...
                    <div class="form-inline">
                        ...
                        <select name="day" id="date" class="form-control demo-default" style="margin-bottom:10px;"
                            required>
                        ...
                        <select name="month" id="month" class="form-control demo-default" style="margin-bottom:10px;"
                            required>
                        ...
                        <select name="year" id="year" class="form-contol demo-default"
                            style="margin-bottom:10px;padding:6px;" required>
                    ...
                    <div class="form-gruop">
                        ...
                        <input type="text" name="contact_no" id="contact_no" placeholder="03*********"
                            pattern="^\d{11}$" title="11 numeric characters only" class="form-control" maxlength="11"
