...
!(function () {
        ...
        (b +=
          (v = void 0 !== p && p) && k
            ...
            ? "translate(calc(-50% + " +
              ...
              u.y / D +
              "em)) "
            : "translate(" + u.x / D + "em, " + u.y / D + "em) "),
        (b +=
          "scale(" +
          (u.size / D) * (u.flipX ? -1 : 1) +
          ", " +
          (u.size / D) * (u.flipY ? -1 : 1) +
          ") "),
  ...
  var jt = function (t) {
    ...
    It = function (t) {
      ...
      return (
        T.autoA11y &&
          (r
            ? (e["aria-labelledby"] = T.replacementClass + "-title-" + B())
            : (e["aria-hidden"] = "true")),
        e
      );
    },
  ...
  var Dt = { fill: "currentColor" },
    Wt = { attributeType: "XML", repeatCount: "indefinite", dur: "2s" },
    Xt = {
      tag: "path",
      attributes: E({}, Dt, {
    ...
    Bt = {
      ...
      children: [
        ...
        {
          tag: "circle",
          attributes: E({}, Dt, { cx: "256", cy: "364", r: "28" }),
          children: [
            {
              tag: "animate",
              attributes: E({}, Wt, {
            ...
            {
              tag: "animate",
              attributes: E({}, qt, { values: "1;0;1;1;0;1;" }),
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: "animate",
              attributes: E({}, qt, { values: "1;0;0;0;0;1;" }),
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: "animate",
              attributes: E({}, qt, { values: "0;0;1;1;0;0;" }),
            },
          ],
        },
      ],
  ...
  function Qt(t, e) {
    var r = { found: !1, width: 512, height: 512, icon: Bt };
    if (t && e && Ut[e] && Ut[e][t]) {
      var a = Ut[e][t];
      r = {
        found: !0,
              ...
              [":before", ":after"].forEach(function (e) {
                ...
                if (t && !a) u.removeChild(t);
                  ...
                  var i = r.getPropertyValue("content"),
                    o = ~["Light", "Regular", "Solid"].indexOf(a[1])
                      ? Gt[a[1]]
                      : Jt[n],
