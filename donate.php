...
if(isset($_POST['submit'])){
        ...
        if(isset($_POST['name']) && !empty($_POST['name'])){
            if(preg_match('/^[A-Za-z\s]+$/', $_POST['name'])){
              $name=$_POST['name'];
                ...
                <strong>Only upper and lower case and space characters are allowed.</strong>
     ...
     if(isset($_POST['email']) && !empty($_POST['email'])){
        ...
        if(preg_match($pattern, $_POST['email'])){
          ...
          if(mysqli_num_rows($result)>0){
            ...
            <strong>Sorry this mail is already exist.</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
           </div>'; 
    ...
    if(isset($name) && isset($blood_group) && isset($gender)&& isset($day) && isset($month) && isset($year) && isset($blood_group) && isset($email) && isset($contact) 
    && isset($password)){
     $DOB=$year."-".$month."-".$day;
     //md5 is an encrytion function ,password ek 32bits ki string mei convert hojaegi,or fir koi aapka database dekhega toh bhi ppassword ka pta nhi chlega.
     $password=md5($password);

     $sql= "INSERT INTO donor (name,gender,email,city,dob,contact_no,save_life_date,password,blood_group) VALUES('$name','$gender','$email','$city',
     '$DOB','$contact','0','$password','$blood_group')";
     $result=mysqli_query($conn,$sql);
     if($result){
...
<div class="container-fluid red-background size">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <h1 class="text-center">Donate(registration)</h1>
            <hr class="white-bar">
        </div>
    </div>
</div>
            ...
            <form action="" method="post" class="form-group">
                ...
                <!-- Blood Group  -->
                 <div class="form-group">
                    ...
                    <select name="blood_group" id="blood_group" class="form-control demo-default" required>
                 ...
                 <!-- Gender -->
                  <div class="form-group">
                    ...
                    Female <input type="radio" name="gender" id="gender" value="Female" style="margin-left:10px; margin-right:10px;"
                  ...
                  <!-- DOB -->
                   ...
                   <select name="day" id="date" class="form-control demo-default" style="margin-bottom:10px;" required>
                   ...
                   <select name="month" id="month" class="form-control demo-default" style="margin-bottom:10px;" required>
                   ...
                   <select name="year" id="year" class="form-contol demo-default" style="margin-bottom:10px;padding:6px;" required>
                   ...
                   <!-- Email -->
                    ...
                    <div class="form-gruop">
                        ...
                        <input type="text" name="contact_no" id="contact_no" placeholder="03*********" pattern="^\d{11}$" title="11 numeric characters only" class="form-control" maxlength="11"
